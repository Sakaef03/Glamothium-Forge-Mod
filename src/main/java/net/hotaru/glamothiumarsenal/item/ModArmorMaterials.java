...
public enum ModArmorMaterials implements ArmorMaterial {
    GLAMOTHIUM("glamothium", 26, new int[]{ 5, 7, 5, 4}, 25, SoundEvents.ARMOR_EQUIP_IRON, 2f, 2f, () -> Ingredient.of(ModItems.GLAMOTHIUM.get()));
    ...
    public String getName() {
        return GlamothiumArsenal.MODID + ":" + this.name;
    }
